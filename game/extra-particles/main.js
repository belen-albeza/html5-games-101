...
function ExplosionEmitter(game) {
    ...
    // call Phaser.Particles.Arcade.Emitter parent constructor
    Phaser.Particles.Arcade.Emitter.call(this, game, 0, 0, MAX_PARTICLES);
...
// inherit from Phaser.Particles.Arcade.Emitter
...
ExplosionEmitter.prototype.spawn = function(x, y) {
    ...
    this.explode(PARTICLE_LIFESPAN * 1000, PARTICLES_PER_BURST);
};
...
PlayState.create = function () {
    ...
    // create a group to manage explosions
